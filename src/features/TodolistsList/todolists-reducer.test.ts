...
test('correct todolist should be added', () => {
    ...
    const endState = todolistsReducer(startState, addTodolistTC.fulfilled(payload,'requestId', 'title'))
...
test('correct todolist should change its name', () => {
    ...
    const action = changeTodolistTitleTC.fulfilled(payload, 'requestId',{ todolistId:todolistId2, title:newTodolistTitle} );
